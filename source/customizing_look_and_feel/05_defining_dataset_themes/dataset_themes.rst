...
4. Choose one of the four available methods to define the icon of the dataset theme:

   - "Upload an image" allows you to choose your own image using a file picker
   - "Select a pictogram from a list" allows you to choose an icon from the Opendatasoft icon library
   - "Enter an image URL" allows you to add your own image via a URL
   - "No image" (default) allows you to leave the dataset theme without any associated icon.

5. (optional) If an icon from the Opendatasoft icon library was chosen, its color could be modified by writing the hexadecimal code of the new color or by clicking the color button to use either the Nice colors or the Color wheel.
