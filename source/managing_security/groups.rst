...
.. ifconfig:: language == 'en'
    ...
    .. figure:: groups__index--en.png

        The groups index page

.. ifconfig:: language == 'fr'

    .. figure:: groups__index--fr.png
...
.. ifconfig:: language == 'en'
    ...
    .. figure:: groups__users-index--en.png

        Add a user to a group from the users index

.. ifconfig:: language == 'fr'

    .. figure:: groups__users-index--fr.png
...
.. ifconfig:: language == 'en'
    ...
    .. figure:: groups__edit--en.png

        The group page

.. ifconfig:: language == 'fr'

    .. figure:: groups__edit--fr.png
