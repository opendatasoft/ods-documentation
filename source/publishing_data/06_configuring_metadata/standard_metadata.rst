...
.. list-table::
  ...
  * * Geographic coverage
    ...
    * Click the button of the chosen option amongst the following:
      ...
      * None *(default only if no geographic data found in the dataset)*: the geographic coverage won't be set for the dataset, which won't be searchable through the geographic filter.
