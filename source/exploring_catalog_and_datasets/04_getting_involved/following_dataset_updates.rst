...
.. admonition:: Prerequisite
   ...
   - If you have an OpenDataSoft account, log in. Once logged in, the Follow button become clickable.
   - If you do not have an OpenDataSoft account, and if the portal allows anonymous users to create an OpenDataSoft account, sign up to the portal. Once signed up and logged in, the Follow button become clickable.
