...
The parent domain is able to "push" content pages and datasets to subdomains :doc:`using the distribution feature </managing_subdomains/distribute>`, 
and is also able to easily gather data from the subdomains (provided the parent domain
has access to the subdomain) :doc:`using the harvesters feature </sourcing_and_processing_data/harvesters/ods>`.
