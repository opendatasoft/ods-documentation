...
Parameter Name  | Description
--------------  | -----------
datasetid       | Part of the URL path. Identifier of the dataset. Example: `http://<DOMAINID>/api/dataset/1.0/arbresremarquablesparis2011/`
recordid        | Part of the URL path. Identifier of the record. Example: `http://<DOMAINID>/api/dataset/1.0/<DATASETID>/records/758885b5183fd28f14ecf39e44484fdccf/`
pretty_print    | If set to true (default is false), pretty prints JSON and JSONP outputs.
